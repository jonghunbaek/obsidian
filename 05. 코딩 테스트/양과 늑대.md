...
date: 2025-12-02
aliases:
복습 풀이: 251202(X), 251210(X), 251217(X), 251220(X), 251228(O), 260103(O), 260110(O), 260117(O)
---
# 1차 풀이
```java
...
class Solution {
    ...
    private int getMaxSheep(Set<Integer> nodes, int sheep, int wolf, int[] info, boolean[][] tree) {
        ...
        for (int node : nodes) {
            ...
            int s = getMaxSheep(getNextNode(node, nodes, tree), nextSheep, nextWolf, info, tree);
    ...
    private Set<Integer> getNextNode(int node, Set<Integer> nodes, boolean[][] tree) {
...
class Solution {
    public int solution(int[] info, int[][] edges) {
        ...
        Set<Integer> nodes = new HashSet<>();
        nodes.add(0);
        return count(0, 0, tree, info, nodes);
    }

    private int count(int sheep, int wolf, boolean[][] tree, int[] info, Set<Integer> nodes) {
        int max = sheep;
        ...
        for (int node : nodes) {
            ...
            int s = count(nextSheep, nextWolf, tree, info, getNextNode(node, nodes, tree));
            max = Math.max(max, s);
        }
...
class Solution {
    public int solution(int[] info, int[][] edges) {
        ...
        Set<Integer> nodes = new HashSet<>();
        nodes.add(0);
        return countSheep(0, 0, info, tree, nodes);
    }
    
    private int countSheep(int sheep, int wolf, int[] info, boolean[][] tree, Set<Integer> nodes) {
        int nextSheep = sheep;
        int nextWolf = wolf;
        ...
        for (int node : nodes) {
            ...
            if (nextWolf >= nextSheep) continue;
            Set<Integer> nextNodes = getNextNodes(node, nodes, tree);
            nextSheep += countSheep(nextSheep, nextWolf, info, tree, nextNodes);
        }
...
class Solution {
    public int solution(int[] info, int[][] edges) {
        ...
        return countMax(0, 0, nodes, info, tree);
    }
    
    private int countMax(int sheep, int wolf, Set<Integer> nodes, int[] info, boolean[][] tree) {
        int maxSheep = sheep;
        ...
        for (int node : nodes) {
            ...
            Set<Integer> nextNodes = findNextNodes(node, nodes, tree);
            int result = countMax(nextSheep, nextWolf, nextNodes, info, tree);
    ...
    private Set<Integer> findNextNodes(int node, Set<Integer> nodes, boolean[][] tree) {
        Set<Integer> nextNodes = new HashSet<>(nodes);
        nextNodes.remove(node);
        
        for (int i = 0; i < tree[node].length; i++) {
            if (tree[node][i]) nextNodes.add(i);
        }
...
class Solution {
    public int solution(int[] info, int[][] edges) {
        ...
        return countMaxSheep(0, 0, nodes, tree, info);
    }
    
    private int countMaxSheep(int sheep, int wolf, Set<Integer> nodes, boolean[][] tree, int[] info) {
        int maxSheep = sheep;
        for (int node : nodes) {
            int nextSheep = sheep;
            int nextWolf = wolf;
            ...
            if (nextWolf >= nextSheep) continue;
            Set<Integer> nextNodes = getNextNodes(node, nodes, tree);
            maxSheep = Math.max(maxSheep, countMaxSheep(nextSheep, nextWolf, nextNodes, tree, info));
        }
...
class Solution {
    public int solution(int[] info, int[][] edges) {
        ...
        Set<Integer> nodes = new HashSet<>();
        nodes.add(0);
        return count(0, 0, nodes, info, tree);
    }
    
    private int count(int sheep, int wolf, Set<Integer> nodes, int[] info, boolean[][] tree) {
        int maxSheep = sheep;
        ...
        for (int node : nodes) {
            ...
            Set<Integer> nextNodes = getNextNodes(node, nodes, tree);
            int value = count(nextSheep, nextWolf, nextNodes, info, tree);

            maxSheep = Math.max(value, maxSheep);
        }
...
class Solution {
    ...
    private int count(int sheep, int wolf, Set<Integer> nodes, int[] info, boolean[][] tree) {
        ...
        for (int node : nodes) {
            ...
            Set<Integer> nextNodes = findNextNodes(node, nodes, tree);
            int value = count(nSheep, nWolf, nextNodes, info, tree);
            maxSheep = Math.max(maxSheep, value);
        }
